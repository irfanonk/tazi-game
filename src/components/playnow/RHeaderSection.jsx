...
export default function PNHeaderSection() {
  return (
    <div className="inpage-header-box text-center justify-center flex items-center h-[67px] min-h-full bg-[#051B5C]  ">
      ...
      <div className="flex flex-2 justify-center items-center gap-4">
        <div className="text-yellow text-2xl font-bold uppercase">
          live racing
        </div>
        <div className=" text-2xl font-bold uppercase">finished racing</div>
      </div>
