...
export default function PaginationSection() {
  return (
    <div className="pagination-box text-blur-6 text-center justify-center flex items-center h-[67px] min-h-full bg-[#051B5C]  ">
      ...
      <div className="flex flex-1 text-sm justify-center  items-center gap-x-4  ">
        <img
        ...
        {Array.from(Array(15).keys()).map((item, i) => (
          <div
            key={i}
            className="w-[29px] h-[29px] rounded-full border-2 border-[#2099AB] hover:bg-yellow text-white transition duration-200 "
          >
            {item + 1}{" "}
          </div>
        ))}
      ...
      <div className="flex flex-1 items-center  justify-end mr-14 ">
